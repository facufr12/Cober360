...
import { Row, Col, Image, Container, ListGroup, Dropdown } from 'react-bootstrap';
			...
			<Container>
				<Row>
					<Col lg={4} md={6} sm={12}>
						{/* about company  */}
						<div className="mb-4">
							<Image src={settings.theme.logo} alt={settings.app.name} className='logo-inverse' />
							<div className="mt-4">
								<p>
						...
						<Dropdown>
							...
							<Dropdown.Menu >
								<Dropdown.Item eventKey="1">
									<span className="me-2">
										<svg fill="none" height="13" viewBox="0 0 16 13" width="16" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_5543_19736)"><path d="M0 0.5H16V12.5H0V0.5Z" fill="#012169"></path><path d="M1.875 0.5L7.975 5.025L14.05 0.5H16V2.05L10 6.525L16 10.975V12.5H14L8 8.025L2.025 12.5H0V11L5.975 6.55L0 2.1V0.5H1.875Z" fill="white"></path><path d="M10.6 7.525L16 11.5V12.5L9.225 7.525H10.6ZM6 8.025L6.15 8.9L1.35 12.5H0L6 8.025ZM16 0.5V0.575L9.775 5.275L9.825 4.175L14.75 0.5H16ZM0 0.5L5.975 4.9H4.475L0 1.55V0.5Z" fill="#C8102E"></path><path d="M6.025 0.5V12.5H10.025V0.5H6.025ZM0 4.5V8.5H16V4.5H0Z" fill="white"></path><path d="M0 5.325V7.725H16V5.325H0ZM6.825 0.5V12.5H9.225V0.5H6.825Z" fill="#C8102E"></path></g><defs><clipPath id="clip0_5543_19736"><rect fill="white" height="12" transform="translate(0 0.5)" width="16"></rect></clipPath></defs></svg>
									</span>
									English
								</Dropdown.Item>
								<Dropdown.Item eventKey="2">
									<span className="me-2">
										<svg fill="none" height="13" viewBox="0 0 16 13" width="16" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_5543_19744)"><path clipRule="evenodd" d="M0 0.5H16V12.5H0V0.5Z" fill="white" fillRule="evenodd"></path><path clipRule="evenodd" d="M0 0.5H5.3325V12.5H0V0.5Z" fill="#002654" fillRule="evenodd"></path><path clipRule="evenodd" d="M10.668 0.5H16.0005V12.5H10.668V0.5Z" fill="#CE1126" fillRule="evenodd"></path></g><defs><clipPath id="clip0_5543_19744"><rect fill="white" height="12" transform="translate(0 0.5)" width="16"></rect></clipPath></defs></svg>
									</span>
									Français
								</Dropdown.Item>
								<Dropdown.Item eventKey="3" >
									<span className="me-2">
										<svg fill="none" height="13" viewBox="0 0 16 13" width="16" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_5543_19751)"><path d="M0 8.5H16V12.5H0V8.5Z" fill="#FFCE00"></path><path d="M0 0.5H16V4.5H0V0.5Z" fill="black"></path><path d="M0 4.5H16V8.5H0V4.5Z" fill="#DD0000"></path></g><defs><clipPath id="clip0_5543_19751"><rect fill="white" height="12" transform="translate(0 0.5)" width="16"></rect></clipPath></defs></svg>
									</span>
									Deutsch
								</Dropdown.Item>
							</Dropdown.Menu>
