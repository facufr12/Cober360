    ...
    return (
        <aside className="docs-nav-sidebar">
                                        ...
                                        {item.children.map((menu, menuIndex) => {
                                            return (
                                                <NavItem as="li" key={menuIndex}>
                                                    <Link to={menu.link} onClick={onClick} className={"nav-link " + (location.pathname === menu.link ? 'active' : '')}>{menu.name}</Link>
                                                </NavItem>
                                            )
                                        })}
                                    </Fragment>
            ...
            <div className="nav-footer">
                <p className="mb-0">
                    Developed by <Link to="https://codescandy.com" target="_blank">Codescandy</Link>
                </p>
            </div>
        </aside>
    )
