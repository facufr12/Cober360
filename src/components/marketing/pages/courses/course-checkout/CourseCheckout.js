					...
					<Col md={12} sm={12} className="mb-3 mt-4">
						...
						<Form.Group controlId="formCardNumber">
							<Form.Label className="d-flex justify-content-between align-items-center ">
								Card Number
								<span>
									<svg aria-hidden="true" className="svg-inline--fa fa-cc-amex text-primary" data-icon="cc-amex" data-prefix="fab" focusable="false" height="18" role="img" viewBox="0 0 576 512" width="18" xmlns="http://www.w3.org/2000/svg">
									...
									{' '}
									<svg aria-hidden="true" className="svg-inline--fa fa-cc-mastercard text-primary" data-icon="cc-mastercard" data-prefix="fab" focusable="false" height="18" role="img" viewBox="0 0 576 512" width="18" xmlns="http://www.w3.org/2000/svg">
										<path fill="currentColor"
									...
									<svg aria-hidden="true" className="svg-inline--fa fa-cc-discover text-primary" data-icon="cc-discover" data-prefix="fab" focusable="false" height="18" role="img" viewBox="0 0 576 512" width="18" xmlns="http://www.w3.org/2000/svg">
										<path fill="currentColor"
									...
									<svg aria-hidden="true" className="svg-inline--fa fa-cc-visa text-primary" data-icon="cc-visa" data-prefix="fab" focusable="false" height="18" role="img" viewBox="0 0 576 512" width="18" xmlns="http://www.w3.org/2000/svg">
										<path fill="currentColor"
