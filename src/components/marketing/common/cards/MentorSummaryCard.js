...
import SignUpModalPopup from 'components/marketing/common/modal-popup/SignUpModalPopup';
        ...
        <Row className="border rounded-3 g-0 mb-3">
            <Col xxl={9} xl={8} xs={12}>
                <Row className="p-lg-5 p-4 gy-5">
                    <Col xl={3} md={3}>
                        <div>
                            <Link to="/marketing/mentor/single">
                                <Image
                                    src={mentor.image}
                                    alt="mentor 1"
                        ...
                        <div className="d-flex flex-column gap-4">
                            <div>
                                <div className="d-flex flex-row align-items-center gap-2">
                                    ...
                                    <span>
                                        <PatchCheckFill size={16} className="text-success" />{' '}
                                    </span>
                                </div>
                ...
                <div className="p-lg-5 p-4 bg-light d-flex flex-column gap-3 rounded-end-xl-3 rounded-bottom-xl-0 rounded-bottom-md-3 h-100">
                    <div className="d-flex flex-column gap-3">
                        ...
                        <div className="d-flex d-xl-grid gap-2">
                            <Link
                                ...
                                className="btn btn-outline-primary w-50 w-xl-100"
                            >
                                Book a Free Trial
                            </Link>
                            <Link
                                to="/marketing/mentor/single"
                                className="btn btn-outline-secondary w-50 w-xl-100"
                            >
                                View Profile
                            </Link>
                        </div>
                    ...
                    <div className="d-flex flex-column gap-2">
                        ...
                        <ListGroup
                            ...
                            className="mb-0 d-flex flex-column gap-2"
                        >
