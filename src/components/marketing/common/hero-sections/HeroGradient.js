					...
					<Col lg={5} xs={12} className="order-md-1">
						...
						>
							{bulletArray.map((item, index) => {
								return (
									<ListGroup.Item key={index} bsPrefix="mb-1" className="d-flex">
										<Icon
											path={mdiCheckCircle}
											size={0.9}
						...
						<div className="mb-8 mb-lg-0">
							<Link to={buttonLink} className="btn btn-primary me-3 mb-2 mb-lg-0">
								{buttonText}
							</Link>
							<Link to={hrefLink} className="text-nowrap btn-link">
								{hrefText}
							</Link>
						</div>
					</Col>
