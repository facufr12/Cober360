							...
							<div className="mt-8 mb-0">
								<ListGroup as="ul" bsPrefix="list-inline">
									{bulletArray.map((item, index) => {
										return (
											<ListGroup.Item key={index} as="li" bsPrefix="list-inline-item text-dark fw-semi-bold lh-1 fs-4 me-3 mb-2 mb-md-0" >
												<span className="icon-shape icon-xs rounded-circle bg-light-success text-center me-2">
													<Icon path={mdiCheck} size={0.7} className="text-success" />
												</span>
