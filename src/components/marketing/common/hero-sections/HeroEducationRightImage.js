      ...
      <Container>
        <Row className="d-flex align-items-center">
          <Col xxl={5} xl={6} lg={6} xs={12} >
            <div>
              <h1 className="display-2 fw-bold mb-3">{headingPart1}
                <u className="text-warning"><span className="text-primary">{headingPart2}</span></u>
              </h1>
              ...
              <Link to={buttonLink} className="btn btn-dark btn-lg">{buttonText}</Link>
            </div>
          </Col>
