...
import MenteeTestimonialCard from 'components/marketing/common/cards/MenteeTestimonialCard';
import TestimonialModalPopup from 'components/marketing/common/modal-popup/TestimonialModalPopup';

// import data files
import TestimonialsData from 'data/marketing/mentor/TestimonialsData';

const TestimonialsByMentees = () => {
                    ...
                    {Array.from({ length: Math.ceil(TestimonialsData.length / 2) }, (_, i) =>
                        ...
                        return (
                            <Fragment key={chunkIndex}>
                                <Col lg={4} xs={12} className="d-flex flex-column gap-4" >
...
export default TestimonialsByMentees