...
$dark-info: #b09377 !default;`;
    ...
    const changeLogo = `// import media files
            ...
            <div className="docs-content mx-xxl-9">
                ...
                <Row>
                    <Col md={12} xs={12}>
                        ...
                        <Row className="docs-example mt-2">
                            <Col md={12} xs={12}>
                                <div >
                                    ...
                                    <p>Here, we will go over how you can customize the theme/colors in our template.<br /><br />
                                        Theme are color variables, which are defined in <code>/src/assets/scss/theme/_variables.scss</code> file, but it&apos;s not preferable to modify this core style sheet file.
                                    ...
                                    File: <code>/src/assets/scss/_user-variables.scss</code>

                                    <p>In order to demonstrate this, here is a code example you can paste into <code>/src/assets/scss/_user-variables.scss</code>, save the file and check the result of customized colors.</p>
                            ...
                            <Col md={12} xs={12}>
                                ...
                                <div >
                                    ...
                                    File: <code>AppConfig.js</code>

                                    <p>Open the above mentioned file, located at <code>/src/AppConfig.js</code> and modify urls for logo to change logo.</p>
                            ...
                            <Col md={12} xs={12}>
                                ...
                                <div >
                                    ...
                                    File: <code>/public/favicon.ico</code>
                                </div>
                            </Col>
