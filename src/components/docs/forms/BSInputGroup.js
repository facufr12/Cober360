...
import { formInputGroupLinks } from 'data/docs/SidebarContentLinks';

const BSInputGroup = () => {
	return (
		<DocsInnerLayout links={formInputGroupLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				...
				<div id='checkboxes-and-radios'></div>
				<hr className="mb-5 mt-7" />
				...
				<div id='buttons-with-dropdowns'></div>
				<hr className="mb-5 mt-7" />
