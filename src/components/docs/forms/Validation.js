...
import { formValidationLinks } from 'data/docs/SidebarContentLinks';
...
const Validation = () => {
	...
	return (
		<DocsInnerLayout links={formValidationLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				...
				<div id='native-html5-validation'></div>
				...
				<div id='form-libraries-and-server-rendered-styles'></div>
				<hr className="mb-5 mt-7" />
				...
				<div id='input-group-validation'></div>
				<hr className="mb-5 mt-7" />
