...
import { formLayoutsLinks } from 'data/docs/SidebarContentLinks';

const Layouts = () => {
	return (
		<DocsInnerLayout links={formLayoutsLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				...
				<div id='horizontal-form-label-sizing'></div>
				<hr className="mb-5 mt-7" />
