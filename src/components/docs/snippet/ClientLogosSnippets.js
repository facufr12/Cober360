...
import { Clients1, Clients1Code } from 'data/docs/snippets/client-logos/Clients1';
import { Clients2, Clients2Code } from 'data/docs/snippets/client-logos/Clients2';
import { Clients4, Clients4Code } from 'data/docs/snippets/client-logos/Clients4';
import { Clients3, Clients3Code } from 'data/docs/snippets/client-logos/Clients3';
import { Clients5, Clients5Code } from 'data/docs/snippets/client-logos/Clients5';
import { Clients6, Clients6Code } from 'data/docs/snippets/client-logos/Clients6';
import { Clients7, Clients7Code } from 'data/docs/snippets/client-logos/Clients7';
