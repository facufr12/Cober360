...
import { Review1, Review1Code } from 'data/docs/snippets/reviews/Review1';
import { Review2, Review2Code } from 'data/docs/snippets/reviews/Review2';

const ReviewsSnippets = () => {
    ...
    const SnippetSectionData = [
        {
            ...
            title: 'Reviews',
            tabContent: <Review1 />,
            codeContent: Review1Code
        },
        {
            hrefID: 'reviews',
            title: 'Review Counter',
            tabContent: <Review2 />,
            codeContent: Review2Code
        }
...
export default ReviewsSnippets