...
import { Footer1, Footer1Code } from 'data/docs/snippets/footers/Footer1';
import { Footer2, Footer2Code } from 'data/docs/snippets/footers/Footer2';
import { Footer3, Footer3Code } from 'data/docs/snippets/footers/Footer3';
import { Footer4, Footer4Code } from 'data/docs/snippets/footers/Footer4';
import { Footer5, Footer5Code } from 'data/docs/snippets/footers/Footer5';
import { Footer6, Footer6Code } from 'data/docs/snippets/footers/Footer6';
import { Footer7, Footer7Code } from 'data/docs/snippets/footers/Footer7';
