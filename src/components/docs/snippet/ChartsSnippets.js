...
import { DataWithBarChart, DataWithBarChartCode } from 'data/docs/snippets/charts/DataWithBarChart';
import { DataWithLineChart, DataWithLineChartCode } from 'data/docs/snippets/charts/DataWithLineChart';
import { BarChart, BarChartCode } from 'data/docs/snippets/charts/BarChart';
import { DonutChart, DonutChartCode } from 'data/docs/snippets/charts/DonutChart';
import { LineChart, LineChartCode } from 'data/docs/snippets/charts/LineChart';
    ...
    return (
        <DocsInnerLayout fullWidth >
            <div className="docs-content">
                ...
                />
                <Link to="https://apexcharts.com/react-chart-demos/" target="_blank">
