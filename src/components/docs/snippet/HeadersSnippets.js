...
import { Header1, Header1Code } from 'data/docs/snippets/headers/Header1';
import { Header2, Header2Code } from 'data/docs/snippets/headers/Header2';
import { Header3, Header3Code } from 'data/docs/snippets/headers/Header3';
import { Header4, Header4Code } from 'data/docs/snippets/headers/Header4';
import { Header5, Header5Code } from 'data/docs/snippets/headers/Header5';
import { Header6, Header6Code } from 'data/docs/snippets/headers/Header6';
import { Header7, Header7Code } from 'data/docs/snippets/headers/Header7';
import { Header8, Header8Code } from 'data/docs/snippets/headers/Header8';
