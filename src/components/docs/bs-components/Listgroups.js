...
import {
	...
	WithIconCode,
	GroupWithIconCode,
	NumberedListgroupCode
} from 'data/code/ListgroupsCode';

// import required data files
import { listGroupLinks } from 'data/docs/SidebarContentLinks';
...
const Listgroups = () => {
	...
	return (
		<DocsInnerLayout links={listGroupLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Listgroup"
					description="List groups are a flexible and powerful component for displaying
				...
				<Row>
					<Col xl={12} lg={12} md={12} sm={12}>
						<div className="mb-4">
							<h3>Numbered</h3>
							<p>
								Add the <code>numbered</code> prop to opt into numbered list group items. Numbers are generated via CSS (as opposed to a <code>&lt;ol&gt;</code>s default browser styling) for better placement inside list group items and to allow for better customization.
							</p>
						</div>
						<Tab.Container defaultActiveKey="design">
							<Card>
								...
								<Card.Body className="p-0">
									<Tab.Content>
										...
										<Tab.Pane eventKey="react" className="pb-4 p-4 react-code">
											<HighlightCode code={NumberedListgroupCode} />
										</Tab.Pane>
									</Tab.Content>
								</Card.Body>
							</Card>
