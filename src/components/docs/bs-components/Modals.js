...
import { modalLinks } from 'data/docs/SidebarContentLinks';
...
const Modals = () => {
  ...
  <p>Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl
	...
	return (
		<DocsInnerLayout links={modalLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Modal"
					description="Add dialogs to your site for lightboxes, user notifications, or
				...
				<div id="scrolling-long-content"></div>
				<hr className="mb-5 mt-7" />
				...
				<div id="vertically-centered"></div>
				<hr className="mb-5 mt-7" />
				...
				<div id="tooltips-and-popovers" ></div>
				<hr className="mb-5 mt-7" />
