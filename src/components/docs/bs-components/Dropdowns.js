...
import { dropdownLinks } from 'data/docs/SidebarContentLinks';

const Dropdowns = () => {
	return (
		<DocsInnerLayout links={dropdownLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Dropdowns"
					description="Toggle contextual overlays for displaying lists of links and
				...
				<div id="responsive-alignment"></div>
				<hr className="mb-5 mt-7" />
