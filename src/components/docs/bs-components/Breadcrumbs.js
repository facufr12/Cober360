				...
				<Row>
					<Col xl={12} lg={12} md={12} sm={12}>
						<div className="mb-4">
							<h3>Dividers</h3>
							<p>
								Dividers are automatically added in CSS through <Link to="https://developer.mozilla.org/en-US/docs/Web/CSS/::before" target="_blank">::before <i className="fe fe-external-link"></i></Link> and content .
