...
import { buttonsGroupLinks } from 'data/docs/SidebarContentLinks';

const ButtonGroups = () => {
	return (
		<DocsInnerLayout links={buttonsGroupLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Button Group"
					description="Group a series of buttons together on a single line with the
									button group."
				/>
				...
				<div id="mixed-outline-styles"></div>
				<hr className="mb-5 mt-7" />
				...
				<div id="checkbox-and-radio-button-groups"></div>
				<hr className="mb-5 mt-7" />
