...
import { tableLinks } from 'data/docs/SidebarContentLinks';

const Tables = () => {
	return (
		<DocsInnerLayout links={tableLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Tables"
					description="Documentation and examples for opt-in styling of tables (given
