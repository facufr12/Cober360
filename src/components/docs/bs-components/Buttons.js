...
import { buttonsLinks } from 'data/docs/SidebarContentLinks';

const Buttons = () => {
	return (
		<DocsInnerLayout links={buttonsLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Buttons"
					description="Custom button styles for actions in forms, dialogs, and more
