...
import { NavTabLinks } from 'data/docs/SidebarContentLinks';

const Navs = () => {
	return (
		<DocsInnerLayout links={NavTabLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				...
				<div id='horizontal-alignment'></div>
				<hr className="mb-5 mt-7" />
				...
				<div id="working-with-flex-utilities"></div>
				<hr className="mb-5 mt-7" />
				...
				<div id="javascript-behavior"></div>
				<hr className="mb-5 mt-7" />
