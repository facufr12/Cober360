...
import { navBarLinks } from 'data/docs/SidebarContentLinks';

const Navbars = () => {
	return (
		<DocsInnerLayout links={navBarLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Navbar"
					description="A powerful, responsive navigation header, the navbar. Includes
