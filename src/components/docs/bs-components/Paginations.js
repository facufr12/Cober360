...
import { paginationLinks } from 'data/docs/SidebarContentLinks';

const Paginations = () => {
	return (
		<DocsInnerLayout links={paginationLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Pagination"
					description="Documentation and examples for showing pagination to indicate a
				...
				<div id="disabled-and-active-states" ></div>
				<hr className="mb-5 mt-7" />
