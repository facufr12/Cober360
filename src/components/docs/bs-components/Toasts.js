...
import { toastLinks } from 'data/docs/SidebarContentLinks';
...
const Toasts = () => {
	...
	return (
		<DocsInnerLayout links={toastLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Toast"
					description="Push notifications to your visitors with a toast, a lightweight
