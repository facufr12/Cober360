...
import { cardLinks } from 'data/docs/SidebarContentLinks';

const Cards = () => {
	return (
		<DocsInnerLayout links={cardLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Cards"
					description="Geek&apos;s cards provide a flexible and extensible content container
