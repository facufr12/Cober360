...
import { spinnerLinks } from 'data/docs/SidebarContentLinks';

const Spinners = () => {
	return (
		<DocsInnerLayout links={spinnerLinks} id="intro">
			<div className="docs-content mx-xxl-9">
				<PageHeadingDescription
					title="Spinners"
					description="Indicate the loading state of a component or page with Bootstrap
								spinners, built entirely with HTML, CSS, and no JavaScript."
				/>


				<div id="border-spinner"></div>
