...
import { Avatar, AvatarGroup } from 'components/docs/bs-components/Avatar';

const TableHover = ({ TableData }) => {
    ...
    return (
        <Card>
            <Card.Header>
                <h4 className="mb-1">Table Hover</h4>
                <p className="mb-0">Add <code className="highlighter-rouge">.table-hover</code> to enable a hover state on
                    table rows within a <code className="highlighter-rouge">&lt;tbody&gt;</code>.</p>
            </Card.Header>
            <Table responsive className="table-hover text-nowrap mb-0 table-centered">
                <thead>
                    <tr>
                        <th>Project name</th>
                        <th>Due Date</th>
