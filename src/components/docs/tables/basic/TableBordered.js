    ...
    return (
        <Card>
            <Card.Header className="border-bottom-0">
                <h4 className="mb-1">Table Bordered</h4>
                <p className="mb-0">Add <code className="highlighter-rouge">.table-bordered</code> for borders on all sides of
                    the table and cells.</p>
            </Card.Header>
            <Table responsive className="table-bordered text-nowrap mb-0 table-centered">
                <thead>
                    <tr>
                        <th>Project name</th>
                        <th>Due Date</th>
