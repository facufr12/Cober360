    ...
    return (
        <Card>
            <Card.Header>
                ...
                <p className="mb-0">Add <code className="highlighter-rouge">.table-borderless</code> for a table without
                    borders.</p>
            </Card.Header>
            <Table responsive className="table-borderless text-nowrap mb- table-centered">
                <thead>
                    <tr>
                        <th>Project name</th>
                        <th>Due Date</th>
