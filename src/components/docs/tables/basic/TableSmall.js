...
const TableSmall = ({ TableData }) => {
    ...
    return (
        <Card>
            <Card.Header >
                <h4 className="mb-1">Table Small</h4>
                <p className="mb-0">Add <code className="highlighter-rouge">.table-sm</code> to make tables more compact by
                    cutting cell padding in half.</p>
            </Card.Header>
            <Table responsive className="table-sm text-nowrap mb-0 table-centered">
                <thead>
                    <tr>
                        <th>Project name</th>
                        <th>Due Date</th>
