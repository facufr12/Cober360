...
import { InstructorReviewsData as ReviewsData } from 'data/marketing/InstructorReviewsData';
        ...
        <section className='p-4 bg-light rounded-3'>
            <Card className="border-0">
                <Card.Header className="d-lg-flex align-items-center justify-content-between">
                    ...
                    <div>
                        <Link to="#" className="btn btn-outline-primary btn-sm">  Export To CSV... </Link>
                    </div>
                </Card.Header>
                <Card.Body>
                    <Form className="mb-4">
