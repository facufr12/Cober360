...
// import media files
import CertificateImg from 'assets/images/education/certificate.jpg';
                ...
                <Row className="align-items-center ">
                    <Col xl={5} lg={6} md={12} xs={12}>
                        <div className="mb-6 mb-lg-0">
                            <div className="mb-2">
                                <Image src={CertificateImg} alt="certificate" className="img-fluid w-100" />
                            </div>
