...
import CategoryCard from 'components/marketing/common/cards/CategoryCard';

export const CategoryCardTabContent = () => {
    const data = [{
        id: 1,
        link: '#',
        name: 'Engineering',
...
export const CategoryCardTabContentCode = `
// import node module libraries
import { Col, Container, Row } from 'react-bootstrap';
...
export const CategoryCardTabContentExample = () => {
    const data = [{
        id: 1,
        link: '#',
        name: 'Engineering',
